...
class PureStrategyEngine:
    ...
    def generate_signal(
        ...
        *,
        ...
        trade_levels = self.calculate_trade_levels(ticker, core_signal, df_ohlcv, event)
                ...
                if signal_v1 is not None:
                    ...
                    if signal_v1['signal'] != 0:
                        ...
                        signal_logger.info(
                            ...
                            f"Entry: {signal_v1['entry_price']:.5f} | "
                            f"SL: {signal_v1['stop_loss']:.5f} | "
                            f"TP: {signal_v1['take_profit']:.5f}"
                        )
                ...
                if signal_v2 is not None:
                    ...
                    if signal_v2['signal'] != 0:
                        ...
                        signal_logger.info(
                            ...
                            f"Confidence: {signal_v2['confidence']:.1%} | "
                            f"Entry: {signal_v2['entry_price']:.5f} | "
                            f"SL: {signal_v2['stop_loss']:.5f} | "
                            f"TP: {signal_v2['take_profit']:.5f}"
                        )
