#!/usr/bin/env python3
"""
Fixed CSV Data Loader with Timezone Handling
"""
        ...
        for index, row in df.iterrows():
            try:
                ...
                if hasattr(timestamp, 'tz') and timestamp.tz is not None:
                    timestamp = timestamp.tz_convert(None)  # Convert to naive datetime
...
def load_csv_data_fixed():
    """Load data from CSV files into database with proper timezone handling"""
