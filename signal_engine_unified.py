    ...
    def execute_trade_pipeline(
        ...
        try:
            ...
            if is_trade_expired(trade_signal):
                logging.warning(f"[PIPELINE_EXECUTION] Trade expired for {ticker}-{interval}")
                logging.info(
            ...
            # ═══════════════════════════════════════════════════════════════════════
            # LOG 7: DATABASE INSERT
            # ═══════════════════════════════════════════════════════════════════════
            logging.info(f"[PIPELINE_EXECUTION] LOG 7: Preparing to send signal to pipeline consumers (events, persistence, etc.) | trade_id={trade_signal.trade_id}")
            
            # ═══════════════════════════════════════════════════════════════════════
            # LOG 8: BROADCAST TO TELEGRAM
            # ═══════════════════════════════════════════════════════════════════════
