                ...
                try:
                    ...
                    if signal != 0:  # signal is Signal(-1/0/1) from enum
                        ...
                        self.db.save_ml_signal(
                            ...
                            feature_snapshot=json.dumps(signal_data.get('features', {})),
                            model_version='strategy_core_v2',
                            triggered_by='v2_persistence',
                        ...
                        v2_signal_id = f"{symbol}|{check_interval}|{signal_data['timestamp']}|v2_persistence"
                        self.pipeline_tracker.update_stage(
                    ...
                    logger.error(
                        f"[V2_PERSISTENCE] Error advancing state for signal {signal_id}: {e}"
                    )
